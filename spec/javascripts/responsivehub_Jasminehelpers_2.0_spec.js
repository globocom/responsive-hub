describe("Jasmine 2.0 Helpers for ResponsiveHub", function() {
  ...
  it("should define $.responsiveHub.jasmine2Helpers", function() {
    expect($.responsiveHub.jasmine2Helpers).not.toBe(undefined);
  });
